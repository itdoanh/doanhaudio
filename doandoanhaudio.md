...
**Mục tiêu:** Méo hài < 0.005% ở 35kHz, nền âm tĩnh lặng tuyệt đối (Zero Hiss).

### 2.1. Cấu hình phần cứng
- **IC Khuếch đại:** Texas Instruments TPA3255 (Chế độ BTL Direct-Coupled).
- **Nguồn cấp:** 48V DC (Trực tiếp từ Pin). Gain: 18dB (Thấp nhất).
- **Bộ lọc LC (Acoustic-Matched 85kHz):** Cuộn cảm 5.0 µH (Lõi không khí Air-Core, dây Litz) + Tụ WIMA FKP2 0.47 µF / 100V.
- **Vi mạch Snubber:** 4.7 Ohms + 0.01 µF tại cọc loa triệt sóng RF.

### 2.2. Công nghệ đặc chế
*   **Active DC-Servo:** Dùng Op-Amp OPA2188 (Zero-drift) liên tục triệt tiêu dòng rò rỉ DC (DC Offset) tại cọc loa về 0.000V, đảm bảo màng loa BlieSMa 97dB luôn nằm đúng tâm tuyệt đối.
*   **Lead-Compensated PFFB:** PFFB Vi sai toàn phần với tụ bù pha C0G 33pF đóng song song với trở hồi tiếp, giúp tín hiệu 35kHz chạy về chip nhanh hơn một nhịp, bóp chết méo hài ở dải siêu cao.
*   **Hố đen nhiễu nền (Attenuating Buffer):** Tầng vào dùng OPA1656 thiết kế dạng suy hao (-6dB). Nhận tín hiệu Max từ DSP và gọt sạch nhiễu trước khi vào TPA3255.

---

## 3. MODULE 2 (MIDRANGE): SCAN-SPEAK 10F/4424G00 - "ZERO-INERTIA BTL"
**Tính chất củ loa:** Màng siêu nhẹ (Mms = 2.8g), Le = 0.1mH, 4 Ohms. Tốc độ chớp nhoáng nhưng dễ bị gắt nếu amply mất kiểm soát.  
**Mục tiêu:** Trễ pha 0 độ trong dải Vocal (300Hz - 3kHz), tối đa hóa Damping Factor.

### 3.1. Cấu hình phần cứng
- **IC Khuếch đại:** Texas Instruments TPA3255 (Chế độ BTL).
- **Nguồn cấp:** 48V DC (Qua lọc LC chống nhiễu).
- **Bộ lọc LC (High-Speed 50kHz):** Cuộn cảm 7.0 µH Lõi từ Ferrite dòng cao (DCR < 10mΩ, vd: Coilcraft) + Tụ 1.0 µF MKP.
- **Mạng bù kháng Zobel:** Bắt buộc có (R = 4.7 Ohms / 5W + C = 0.1 µF) để khóa trở kháng tại 4 Ohms.

### 3.2. Công nghệ đặc chế
*   **Kelvin Sense PFFB:** Đường hồi tiếp kéo thẳng từ chân cọc cắm dây loa vật lý vòng ngược về IC. Amply tự động bù trừ luôn nội trở của đoạn mạch đồng, ép THD ở 1kHz xuống < 0.001%.
*   **Tầng đệm thuần vi sai:** OPA1656 cấu hình Fully Balanced, sai số linh kiện 0.1%, loại bỏ 100% nhiễu Common-Mode gây méo gắt dải trung.
